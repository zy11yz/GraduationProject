...
def emtion_anls():
    ...
    # 打开词典文件，返回列表
    def open_dict(Dict='hahah', path='C:\\users\\zy\\desktop\\ydzx2\\sentiment\\'):
    ...
    deny_word = open_dict(Dict='否定词', path='C:\\users\\zy\\desktop\\ydzx2\\sentiment\\')
    posdict = open_dict(Dict='positive', path='C:\\users\\zy\\desktop\\ydzx2\\sentiment\\')
    negdict = open_dict(Dict='negative', path='C:\\users\\zy\\desktop\\ydzx2\\sentiment\\')

    degree_word = open_dict(Dict='程度级别词语', path='C:\\users\\zy\\desktop\\ydzx2\\sentiment\\')
